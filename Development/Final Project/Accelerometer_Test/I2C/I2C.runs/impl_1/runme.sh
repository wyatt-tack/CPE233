...
HD_PWD='C:/Users/Wyatt/Documents/Vivado/CPE233_Final/Accelerometer_Test/I2C/I2C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gyro_Test.tcl -notrace
