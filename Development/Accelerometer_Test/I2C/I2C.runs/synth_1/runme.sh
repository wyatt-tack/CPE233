...
HD_PWD='C:/Users/Wyatt/Documents/Vivado/CPE233_Final/Accelerometer_Test/I2C/I2C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gyro_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gyro_Test.tcl
